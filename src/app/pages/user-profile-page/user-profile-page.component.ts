...
import { HomeCitiesComponent } from "../../shared/home-cities/home-cities.component";
...
@Component({
  ...
  directives: [<Type>ContentPanelComponent, <Type>EditableTextComponent, <Type>HomeCitiesComponent]
})
